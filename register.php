...
<head>
    ...
    <title>Register - Perpus Cloud</title>
...
<body class="bg-[#1a222c] font-sans antialiased">
    <div class="min-h-screen flex flex-col justify-center items-center px-4 relative overflow-hidden">
        ...
        <div class="mb-8 text-center relative z-10">
            ...
            <p class="text-gray-400 text-sm">Bergabunglah dengan Ekosistem Literasi Digital</p>
        </div>
            ...
            <div class="bg-[#24303f] border border-[#2e3a47] p-8 rounded-2xl shadow-2xl transition-all duration-300 hover:border-blue-500/50">
                ...
                <form action="register_process.php" method="post" class="space-y-5">
                    ...
                    <div class="flex items-center justify-end">
                        <a href="index.php" class="text-sm text-blue-500 hover:underline hover:text-blue-400 transition">
